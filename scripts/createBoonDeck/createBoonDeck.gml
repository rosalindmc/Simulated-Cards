...
defineBoonCard("","Gain 1 Action Point","","Lose 1 Action Point")
defineBoonCard("","Become Focused","","Suffer Minor Distraction for 1 round")
defineBoonCard("","Become Focused","","Suffer Minor Distraction for 1 round")
...
defineBoonCard("","Become Bold","There is a loaded crossbow or firearm on your person","Misfire a loaded weapon.# Where the projectile goes is entirely determined on where it is stored.")
...
defineBoonCard("","Draw +3 Hit Locations and choose one","You do NOT have Novice Coordination on a non-spear melee attack","Strike Self in a random location for 1/2 Weapon Strength (Round Up)")
defineBoonCard("","Draw +3 Hit Locations and choose one","You do NOT have Adept Coordination on a non-spear melee attack","Strike Self in a random location for 1/2 Weapon Strength (Round Down)")
...
defineBoonCard("Making a sword type attack","Hit an addtional location","Attacking with a bow or crossbow","Bow string snaps.# Bow is unusable and you suffer a 3 strength sword hit to a random location")
...
defineBoonCard("Weapon Strength is greater than or equal to 1/2 the target's Might (round up)","Target becomes staggered","Ammo stored on your person","Ammo Spill./n Projectiles fall out of a container.")
